...
public class JewelleryActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Jewellery, OngoingViewHolder> FirebaseAdapter = new FirebaseRecyclerAdapter<Jewellery, OngoingViewHolder>(
                Jewellery.class,
                R.layout.design_row,
            ...
            @Override
            protected void populateViewHolder(OngoingViewHolder viewHolder, Jewellery model, int position) {
